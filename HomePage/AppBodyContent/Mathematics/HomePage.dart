...
class HomePage_Pure extends StatelessWidget {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Hero(
                    tag: 'mathematics',
                    child: Image.asset(
                      "assets/subject_icons/maths.png",
                      width: 30.0,
                      height: 30.0,
                    ),
                  ),
                      ...
                      children: <Widget>[
                        new Row(
                          children: <Widget>[
                            ...
                            //new TopicButton("${TopicButtonArray().TopicImage[41]}", "${TopicButtonArray().TopicTitle[41]}", "0"),
                            SizedBox(width: 20.0),
