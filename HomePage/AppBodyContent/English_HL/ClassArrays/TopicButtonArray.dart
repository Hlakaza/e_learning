    ...
    return new InkWell(
      onTap: () {
        ...
        switch (topic_route)
        {
          ...
          break;
          case "3" : topic_route = Topic2R1(); //HomePage_TOUR();
          break;
          case "4" : topic_route = Topic3R1(); //HomePage_TOUR();
          break;
          case "5" : topic_route = Topic4R1(); //HomePage_TOUR();
          break;
          case "6" : topic_route = Topic5R1(); //HomePage_TOUR();
          break;
          //Topic 2
          case "7" : topic_route = Topic6R1(); //HomePage_TOUR();
          break;
          case "8" : topic_route = Topic7R1(); //HomePage_TOUR();
          break;
          case "9" : topic_route = Topic8R1(); //HomePage_TOUR();
          break;
          case "10" : topic_route = Topic9R1(); //HomePage_TOUR();
          break;
          case "11" : topic_route = Topic10R1(); //HomePage_TOUR();
          break;
