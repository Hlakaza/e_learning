...
final List<Entry> data = <Entry> [
  ...
  Entry(
    'B',
    <Entry>[
      Entry('Balloon payment\n an inflated payment at the end of a contract that the customer is soley responsible for It reduces the 
...
Entry('Box-and whisker graph\n a graph that shows the spread or distribution of the data using a number line '),
Entry('Break-even point\n the level of sales at which profit is zero '),
Entry('Broken-line graph\n may have numbers that alternate between increasing and decreasing,it does not keep to a consistent 
curved line '),
...
Entry('Direct relationship\n if one variable increases by a certain amount, the other also increases or decreases by a fixed 
amount '),
Entry('Discrete information\n a series of separate values in which in-between values are not allowed '),
Entry('Disposable income\n income available after all payments '),
Entry('Distance\n describes large length measurements '),
Entry('Domestic customers\n natural persons purchasing electricity in private residential establishments including houses,blocks of 
flat and town house complexes '),
Entry('Double bar graph\n the most common multiple bar graph,it compares two sets of data '),
  ...
  Entry(
    'E',
    <Entry>[
      Entry('Electronic fund transfer\n the electronic exchange or transfer of money from one account to another,through computer based 
systems '),
Entry('Elevation plans\nthese are cross section plans from different direction or sides of a building '),
Entry('Event\n something that happens '),
Entry('Experimental probability(also called relative sequence or empirical probability)\n the probability that is calculated when 
an actual simulation or experiment is performed '),
Entry('Exponential graph\n a curved graph that does not increase or decrease by the same amount each time '),
    ],
  ),
...
Entry('Frequency table\n a table that lists items and uses tally marks to record the number of times an item occurs, it is also 
called a frequency distribution table '),
  ...
  Entry(
    'G',
    <Entry>[
      Entry('Gross domestic product(GDP)\n the market value of all the final products produced in a certain period of time within the 
...
Entry('Initiation fee\n a compulsory once off bank fee that is charged when opening a new account in terms of the National Credit 
...
Entry('Irregular expenses\n occasional expenses that may come up '),
  ...
  Entry(
    'K',
    <Entry>[
      Entry('Kelvin\n a temperature scale designed so that 0 K is defined as absolute zero ( at absolute zero,a hypothetical 
...
Entry('Lower quartile(first quartile or Q1)\n the median of the lower half of the data '),
    ],
  ),
...
Entry('Mass\n a property of objects measured in grams or kilograms, a heavy object has more mass and a lighter object has less 
mass '),
...
Entry('Mode\n the number (or numbers)that occur(s) most often in a data set outlier, a number much bigger or smaller than the rest 
of the values in a dataset '),
Entry('Monthly admin fee\n a compulsory monthly bank fee that is charged for the administration of an account in terms of the 
National Credit Act '),
Entry('Multiple bar graph\n a bar graph that displays two or more sets of data at once for easy comparison '),
Entry('Multiple line graph\na line or brocken line graph that shows changes in data over time for more than one category '),
  ...
  Entry(
    'O',
    <Entry>[
      Entry('Odometer\n an instrument in a car that calculates how far in total the car has travelled,by counting the number of times the 
wheels have completed the revolution '),
Entry('Overdraft facility\n a temporary arrangement with a bank that allows a debit balance on an account '),
  ],
  ),
...
Entry('Power of ten\na number that you get by multiplying 10 by 10, one or more times,example ,100,1 000,10 000 and 1 000 000 are 
all powers of ten '),
...
Entry('Rebate\nan amount of money that is paid back to every tax payer, regardless of the amount of money that is owed in tax ,The 
...
Entry('Stepped block/incline block tariffs\n pricing structure that changes as the number of units used/consumed 
...
Entry('Surplus\n when a government has money left over,it is the opposite of a deficit '),
  ...
  Entry(
    'T',
    <Entry>[
      Entry('Tally\n a system of recording and counting results using short lines,where each line(or tally) represents one response to a 
certain question '),
Entry('Theoretical probability\n the possibility based on mathematical theory that states what 'should' happen over a large number 
of trials '),
Entry('Total cost\n fixed costs plus variable costs for any possible level of output '),
Entry('Travel allowance\n a predetermined daily amount to cover accommodation,(domesÂ&shy;tic only)food,drink and incidentals '),
...
Entry('Trundle wheel\n a wheel at the end of a long handle, the wheel has a circumference of 1 m,so it travels 1 m each time it 
turns along the ground and it records how many times the wheel has turned, which gives the distance in metres '),
Entry('Two way table\n a visual way to express outcomes of an event that can only be used only when you have two variables or two 
events '),
],
  ),
...
Entry('Upper quartile (third quartile or Q3)\n the median of the upper half of the data '),    ],
  ),
