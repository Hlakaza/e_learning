...
class HomepageAC extends StatelessWidget
{
  @override
...
class _CarouselState extends State<Carousel> {
          ...
          child: new Scaffold(
            ...
            appBar: new AppBar(
              ...
              title: Row(
                ...
                children: <Widget>[
                  new Text("Past Paper - Accounting",
                      style: TextStyle(
                        fontSize: 15.0,
                        color: Colors.white,
                        fontFamily: "Raleway",
                  ...
                  Container(
                    ...
                    child: Image.asset(
                      "assets/subject_icons/accounting.png",
                      width: 30.0,
                      height: 30.0,
                    ),
                  ),
  ...
  animateIteBuilder(int index) {
    ...
    switch (index) {
      case 0 :
        paperName = "2018 Accounting \nPaper 1 May/June";
        break;
      case 1 :
        paperName = "2018 Accounting \nPaper 1 Feb/March";
        break;
      case 2 :
        paperName = "2017 Accounting \nPaper 1 Feb/March";
        break;
      case 3 :
        paperName = "2017 Accounting \nPaper 1 May/June";
        break;
